...
public interface CYXVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitAddSubExpr(CYXParser.AddSubExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitLogANDExpr(CYXParser.LogANDExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitMulDivModExpr(CYXParser.MulDivModExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitLogORExpr(CYXParser.LogORExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitBitXORExpr(CYXParser.BitXORExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitMinusExpr(CYXParser.MinusExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitCmpExpr(CYXParser.CmpExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitBitORExpr(CYXParser.BitORExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitEqExpr(CYXParser.EqExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitBitANDExpr(CYXParser.BitANDExprContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CYXParser#selfAddSub}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSelfAddSub(CYXParser.SelfAddSubContext ctx);
	/**
